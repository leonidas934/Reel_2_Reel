...
// Utilisateur
bool Etat_dir = true; //false = Masquer cote interieur de la bobine, True = masquer cote exterieur de la bobine
double Vitesse_des = 30; // cm/min - Vitesse_max = 75 cm/min
double Tension_des = 20; // Tension entre 0 et 100
